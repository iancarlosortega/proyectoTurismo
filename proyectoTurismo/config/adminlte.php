...
return [
    ...
    */
    ...
    'title' => 'Observatorio de Turismo UTPL',
    'title_prefix' => 'Observatorio de Turismo UTPL |',
    'title_postfix' => '',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Gestión de lugares turísticos',
            'route'  => 'lugares.index',
        ...
        [
            ...
            'route'  => 'visualizarDatos',
            'icon'  => 'far fa-fw fa-file-image',
        ],
        ['header'=> 'Estadísticas'],
        [
            'text' => 'Gestión de métricas',
            'route'  => 'metricas.index',
            'icon'  => 'fas fa-fw fa-calculator',
        ],
        [
            'text' => 'Gestión de gráficas',
            'route'  => 'graficas',
