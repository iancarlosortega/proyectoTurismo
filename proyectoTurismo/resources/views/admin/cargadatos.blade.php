...
@section('content')
    {{-- Panel para cargar los archivos utilizando dropzone --}}
    <div>
        <form method="POST"  action="{{route('datos.cargar')}}" class="dropzone" id="my-awesome-dropzone"></form>
    </div>
    <br>
    {{-- Mostrar los archivos cargados en la base de datos --}}
    ...
    Dropzone.options.myAwesomeDropzone = {
      ...
      switch (file.type) {
        case 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet':
          thumbnail.css('background', 'url({{asset("img/iconos/excelIcon.png")}})');//Asignar la url donde se encuentra el icono
          break;
