...
<div class="tab-content" id="myTabContent">
        ...
        <form id="registro-grafica">
            ...
            <div class="form-group">
                ...
                <select id="ddlViewBy" class="form-select" aria-label="Default select example">
                    ...
                    <option value="{{$arc->nombre}}">{{$arc->nombre}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
    ...
    <div class="tab-pane fade" id="grafica" role="tabpanel" aria-labelledby="grafica-tab">
        <h3>Crear Gráfica</h3>
        <form id="generar-grafica" method="post" action="{{route('graficas2.graficar')}}">
            @csrf
            <div class="form-group">
                <label for="exampleInputName">Título</label>
            ...
            <div>
                ...
                <select name="nombre2" id="nombre2" class="form-select" aria-label="Default select example">
                    @foreach ($lugares as $arc)
                    <option value="{{$arc->id}}">{{$arc->nombre}}</option>
                    @endforeach
                </select>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="columnas" id="columnas">
                    @for ($i = 3; $i < $size; $i++) <input type="checkbox" id="columnas" name="columna[]"
                        value="{{$columnas[$i]}}" class="ml-2">
            ...
            <div>
                ...
                <select name="anio" id="anio" class="form-select" aria-label="Default select example">
                    @foreach ($years as $arc)
                    <option value="{{$arc->year}}">{{$arc->year}}</option>
                    @endforeach
                </select>
            </div>
            <div>
                ...
                <select name="mes" id="mes" class="form-select" aria-label="Default select example">
                    @foreach ($month as $arc)
                    <option value="{{$arc->month}}">{{$arc->month}}</option>
                    @endforeach
                </select>
            </div>
            <div align='center'>
...
<script>
    function exportarImg(){
        ...
        filename: name.value,
        url:'upload',
        formAttributes:("X-CSRF-Token", "{{csrf_token()}}")
        });
        return false;
    }
  ...
  <script>
    ...
    $('#usuario_edit_form').submit(function(e){
      ...
      $.ajax({
        ...
        url: "{{ route('graficas2.actualizar') }}",
        type: "POST",
