...
<?php $__env->startSection('content'); ?>
  ...
  <div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
      <h3>Crear Usuario</h3>
      <form id="registro-usuario" class="needs-validation" novalidate>
        <?php echo csrf_field(); ?>
        <div class="form-group">
          <label for="exampleInputName">Nombres y Apellidos</label>
          <input type="text" class="form-control" id="registrarNombre" name="registrarNombre" required>
          <div class="valid-feedback">¡Ok válido!</div>
          <div class="invalid-feedback">Complete el campo.</div>
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Correo electrónico</label>
          <input type="email" class="form-control" id="registrarCorreo" name="registrarCorreo" required>
          <div class="valid-feedback">¡Ok válido!</div>
          <div class="invalid-feedback">Complete el campo.</div>
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Contraseña</label>
          <input type="password" class="form-control" id="registrarContrasenia" name="registrarContrasenia" required>
          <div class="valid-feedback">¡Ok válido!</div>
          <div class="invalid-feedback">Complete el campo.</div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\Proyecto 5TO Ciclo\observatorio\proyectoTurismo\resources\views/admin/usuarios.blade.php ENDPATH**/ ?>