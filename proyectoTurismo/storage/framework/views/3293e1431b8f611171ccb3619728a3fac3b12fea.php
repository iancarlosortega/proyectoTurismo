        ...
        <form id="generar-grafica" method="post" action="<?php echo e(route('graficas2.graficar')); ?>">
            ...
            <div>
                ...
                <div class="columnas" id="columnas">
                    <?php for($i = 4; $i < $size; $i++): ?> <input type="checkbox" id="columnas" name="columna[]"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ispa1\OneDrive\Documentos\GitHub\observatorio\proyectoTurismo\resources\views/admin/graficas.blade.php ENDPATH**/ ?>