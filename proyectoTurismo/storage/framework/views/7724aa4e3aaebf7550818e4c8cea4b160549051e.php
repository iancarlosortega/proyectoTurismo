                ...
                <div class="col-4">
                    <form id="generar-grafica" method="post" action="<?php echo e(route('visualizaciones.actualizar')); ?>">
                        ...
                        <div>      
                            ...
                            <div class="columnas">                
<<<<<<< HEAD:proyectoTurismo/resources/views/visualizaciones.blade.php
                                @for ($i = 2; $i < $size; $i++)
=======
                                <?php for($i = 4; $i < $size; $i++): ?>
>>>>>>> 962e60dacab90220e341e2d22ea50d47bf1498f5:proyectoTurismo/storage/framework/views/7724aa4e3aaebf7550818e4c8cea4b160549051e.php
                                    <div class="filas">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ispa1\OneDrive\Documentos\GitHub\observatorio\proyectoTurismo\resources\views/visualizaciones.blade.php ENDPATH**/ ?>