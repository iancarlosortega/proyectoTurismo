    ...
    <div class="manual">
        ...
        <section>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen4.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen1.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen2.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen3.png')); ?>" alt="Lista de usuarios">
            </div>
        </section>
        <section>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen8.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen-mini">
                <img src="<?php echo e(asset('img/admin/imagen9.png')); ?>" alt="Lista de usuarios">
            </div>
            <p>La categoria se han asignado valores desde 1 hasta 5. Representando 5 la calidad máxima y 1 la calidad mínima.</p>
            <div class="manual-imagen-mini">
                <img src="<?php echo e(asset('img/admin/imagen10.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen-mini">
                <img src="<?php echo e(asset('img/admin/imagen11.png')); ?>" alt="Lista de usuarios">
            </div>
            <p>Una vez seleccionada la imagen respectiva, se mostrará en el recuadro de la parte derecha.</p>
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen12.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen6.png')); ?>" alt="Lista de usuarios">
            </div>
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen7.png')); ?>" alt="Lista de usuarios">
            </div>
        </section>
        <section>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen13.png')); ?>" alt="Lista de usuarios">
            </div>
        </section>
        <section>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen14.png')); ?>" alt="Lista de usuarios">
            </div>
        </section>
        <section>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen15.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen-mini">
                <img src="<?php echo e(asset('img/admin/imagen19.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen18.png')); ?>" alt="Lista de usuarios">
            </div>
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen16.png')); ?>" alt="Lista de usuarios">
            </div>
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen17.png')); ?>" alt="Lista de usuarios">
            </div>
            ...
            <div class="manual-imagen">
                <img src="<?php echo e(asset('img/admin/imagen20.png')); ?>" alt="Lista de usuarios">
            </div>
        </section>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\Proyecto 5TO Ciclo\observatorio\proyectoTurismo\resources\views/dashboard.blade.php ENDPATH**/ ?>