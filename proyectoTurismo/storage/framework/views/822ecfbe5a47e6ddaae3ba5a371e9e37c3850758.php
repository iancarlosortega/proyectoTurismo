    ...
    <script>
        ...
        $(document).ready(function(){
            var tablaLugar = $('#tabla-metrica').DataTable({
                ...
                ajax:{
                    url: "<?php echo e(route('metricas.index')); ?>",
                },
        ...
        // -------------------REGISTRAR METRICA-------------------------
          $(document).ready(function(){
            ...
            $('#registro-metrica').submit(function(e){
                ...
                $.ajax({
                    url: "<?php echo e(route('metricas.registrar')); ?>",
                    type: "POST",
    ...
    <script>
        ...
        $('#metrica_edit_form').submit(function(e){
            e.preventDefault();
                ...
                //Enviar la informacion del formulario al controlador mediante la ruta 'usuarios.registrar'
                $.ajax({
                    url: "<?php echo e(route('metricas.actualizar')); ?>",
                    type: "POST",
                    //Informacion almacenada enviada al controlador
                    data: formData,
                    cache:false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\Proyecto 5TO Ciclo\observatorio\proyectoTurismo\resources\views/admin/metricas.blade.php ENDPATH**/ ?>