    ...
    <header>
        <a class="logo" href="/"><img src="<?php echo e(asset('img/logoObtur.png')); ?>" alt="logo"></a>
            ...
            <?php if(Route::has('login')): ?>
                ...
                <a href="<?php echo e(url('/admin/usuarios')); ?>" class="cta">Dashboard</a>
...
</html><?php /**PATH C:\Users\Usuario\Desktop\Proyecto 5TO Ciclo\observatorio\proyectoTurismo\resources\views/layouts/plantilla.blade.php ENDPATH**/ ?>