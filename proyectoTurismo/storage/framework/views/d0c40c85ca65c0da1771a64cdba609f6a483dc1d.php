    ...
    <footer>
        <div class="footer1">
            <div class="UTPL">
                ...
                ligula.</p>
                <div class="redes">
                    <img src="<?php echo e(asset('img/iconoFacebook.png')); ?>" alt="iconoFacebook">
                    <img src="<?php echo e(asset('img/iconoTwitter.png')); ?>" alt="iconoTwitter">
                    <img src="<?php echo e(asset('img/iconoYoutube.png')); ?>" alt="iconoYoutube">
                    <img src="<?php echo e(asset('img/iconoInstagram.png')); ?>" alt="iconoInstagram">
                </div>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\Users\ispa1\OneDrive\Documentos\GitHub\ProyectoTuristicoUTPL5Ciclo\proyectoTurismo\resources\views/layouts/plantilla.blade.php ENDPATH**/ ?>